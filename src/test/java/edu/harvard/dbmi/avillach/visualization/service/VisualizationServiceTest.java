...
class VisualizationServiceTest {
    ...
    void setUp() {
        ...
        service =
            new VisualizationService(decomposer, hpdsClient, categoricalProcessor, continuousProcessor, binningService, aggregationService);
    }
    ...
    void generateDistributions_authorized_categoricalFilter() {
        ...
        VisualizationResponse response = service.generateDistributions(query, AccessType.AUTHORIZED, "Bearer token");
    ...
    void generateDistributions_open_withObfuscation() {
        ...
        VisualizationResponse response = service.generateDistributions(query, AccessType.OPEN, null);
    ...
    void generateDistributions_requiredNumericFilter_skipsEmptyCategoricalAndReturnsHistogram() {
        ...
        when(hpdsClient.getAuthCrossCounts(any(), eq(ResultType.CATEGORICAL_CROSS_COUNT), any())).thenReturn(emptyCategoricalCounts);
        ...
        when(hpdsClient.getAuthCrossCounts(any(), eq(ResultType.CONTINUOUS_CROSS_COUNT), any())).thenReturn(continuousCounts);
